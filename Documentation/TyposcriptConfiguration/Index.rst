...
If there are only three defined values for :code:`L` like above :code:`0`, :code:`1` or :code:`2` you can
even restrict this to :code:`config.linkVars = L(0-2)`. More examples can be found in the link below.
